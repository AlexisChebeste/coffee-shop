        ...
        <section className=" flex flex-col items-center justify-center" id='events'>
            ...
            <article className="flex flex-col md:flex-row-reverse justify-center items-center  w-full  max-w-6xl  lg:justify-between gap-14 px-4 mx-auto py-12 lg:py-20">
                <div className="relative pb-10 z-10">
                    <img src={evento1} alt="evento 1" className="w-60 h-72 ml-10 lg:ml-30 lg:w-72 lg:h-80" loading='lazy'/>
                    <img src={evento2} alt="evento 2"  className="size-44 absolute -left-3 -bottom-2 -z-10 lg:size-52  lg:-bottom-6" loading='lazy'/>
                </div>
