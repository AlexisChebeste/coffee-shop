        ...
        <section className="max-w-6xl mx-auto px-4 py-8" id='galery'>
            ...
            <div className="grid md:grid-cols-3 md:grid-rows-2 gap-4 mt-8  md:max-h-[800px]">
                <div className='col-span-2 w-full h-full'>
                    <img src={galery1} alt="galeria 1" className='w-full h-full object-cover' loading='lazy'/>
                </div>
                <div className='md:col-span-1 w-full h-full'>
                    <img src={galery2} alt="galeria 2" className='w-full h-full object-cover' loading='lazy'/>
                </div>
                <div className='md:col-span-1 w-full h-full'>
                    <img src={galery3} alt="galeria 3" className='w-full h-full object-cover' loading='lazy'/>
                </div>
                <div className='col-span-2 w-full h-full'>
                    <img src={galery4} alt="galeria 4" className='w-full h-full object-cover' loading='lazy'/>
                </div>
